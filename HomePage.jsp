...
<div class="container1" id="home">
  ...
  <img src="Resources/beuhair interior.jpg" style="width: 100%; height: 100%;" align="right"></img>
  ...
  <h3 style="text-align:center; color:DarkBlue;">Want to checkout all the Services that we offer? Click <a href="services.html">here</a> or the Services tab in top menu!</h3>
  ...
  <div class="content" style="position: relative; text-align: center; color: black; width:100%; height: 100%;">
	<img src="Resources/design.jpg" style="width:100%; height: 420px; opacity:0.30;">
	  ...
	  <h6 style="text-align:center; margin: 0;"><b>I was looking for the perfect salon. THS exceeded my expectations and I've already scheduled my next appointment.</b></h6>
	  <h6 style="text-align:center; margin: 0; padding-top: 15px;"><b>- Charlotte</b></h6>

	  <h6 style="text-align:center; margin: 0;  padding-top: 25px;"><b>All of them are the best. I always walk out of the salon feeling like a million dollars.</b></h6>
	  <h6 style="text-align:center; margin: 0;  padding-top: 10px;"><b>- Brielle</b></h6>

	  <h6 style="text-align:center; margin: 0;  padding-top: 25px;"><b>My friend referred me to THS and I am so happy I decided to give it a try. My hair looks amazing.</b></h6>
