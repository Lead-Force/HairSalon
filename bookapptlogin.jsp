		...
		<label for="Weekday"><b>Day:</b></label>
           ...
           <table border="2">
               <form name="insertApptForm" action="BookAppointmentServlet" method="post">
                ...
                <tr>
                    <td><input type="text" name="hdAptIdTb<%=defaults.indexOf(apptArray[row])%>" value="<%= apptArray[row].getHdAptID()%>"disabled/></td>
                    <td><input type="text" name="timeTb<%=defaults.indexOf(apptArray[row])%>" value="<%= apptArray[row].getAptTime()%>"disabled/></td>
                    <td><input type="text" name="CustID<%=defaults.indexOf(apptArray[row])%>" value="<%= apptArray[row].getCustID() %>"disabled/></td>
                    <td><input type="text" name="weekTb<%=defaults.indexOf(apptArray[row])%>" value="<%= apptArray[row].getWeek()%>"disabled/></td>
                    <td><input type="text" name="dayTb<%=defaults.indexOf(apptArray[row])%>" value="<%= apptArray[row].getAptDays()%>"disabled/></td>
                    <td><input type="text" name="serviceTb<%=defaults.indexOf(apptArray[row])%>" value="<%= apptArray[row].getService()%>"disabled/></td>
                    <td><input type="text" name="reserveTb<%=defaults.indexOf(apptArray[row])%>" value="<%= apptArray[row].getReserved()%>"disabled/></td>
