<%-- 
    Document   : bookappt
    Created on : Apr 13, 2021, 1:29:27 PM
    Author     : krism
--%>
...
<br><br>
	...
	<form action="appttime.jsp" method="post" style="padding-top: 20px;">
	  <center>
		<label for="apptTime"><b>Week:</b></label>
		<input type="week" name="week" id="week" placeholder="Schedule a Time" style="height: auto; width: 190px;" required><br><br>
                
		<label for="CustID"><b>Day:</b></label>
                <select name="weekday" style="height: auto; width: 190px;" required>
