...
<%@page import="BO.HairDresserList"%>
...
<br><br><br>
  <center>
    ...
    <p>Enter the details of a new employee: (Payrate must be in the format xx.x)
            ...
            <form name="HairDresserInsertForm" action="http://localhost:8080/TheSalonProject/HdManagerServlet" method="post">
                 <table><tr>
                        <th>First name:</th>
                        <th>Last name:</th>
                        <th>Address</th>
        ...
        <form name="HairDresserLookupForm" action="http://localhost:8080/TheSalonProject/HdManagerServlet">
            <table>
                <tr>
                        <th>ID:</th>
                        <th>First name:</th>
