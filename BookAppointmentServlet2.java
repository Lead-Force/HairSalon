 ...
 * @author renel
 */
@WebServlet(name = "BookAppointmentServlet2", urlPatterns = {"/BookAppointmentServlet2"})
public class BookAppointmentServlet2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String aptTime, empId, custId, hdAptId, service, reserve;
            boolean taken=false;
...
//multiple line update loop
            ...
            if (value.equals(iconstant+index)){
                ...
                Appointment ia1 = new Appointment(aptTime,custId,hdAptId,taken,Week,AptDays,service,reserve);
                ia1.insertDB(aptTime,custId,hdAptId,taken,Week,AptDays,service,reserve);
                ...
                System.out.println("Appointment ia1 sent to bookappt.jsp");
                RequestDispatcher rd = request.getRequestDispatcher("bookappt.jsp");
                rd.forward(request, response);
                System.out.println("Insert to appointments complete, back to bookappt.jsp");
            ...
            out.println("<h1>Servlet BookAppointmentServlet at " + ia1.getHdAptID()
                    + ia1.getService()+ ia1.getWeek()+ ia1.getReserved()+"</h1>");
            out.println("</body>");
            out.println("</html>");*/
            }
        }
