 ...
 * @author Jean
 */
@WebServlet(name = "DisplayApptServlet", urlPatterns = {"/DisplayApptServlet"})
public class DisplayApptServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        out.close();//Close writer
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DisplayApptServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DisplayApptServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        }
