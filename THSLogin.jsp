<%-- 
    Document   : THSLogin
    Created on : Apr 27, 2021, 9:34:35 PM
    Author     : kimmy
--%>
...
function validateForm() {
  var uname = document.CLoginForm.uname.value;
  var psw = document.CLoginForm.psw.value;
  
  if (uname.length >20 || psw.length>20){
...
<form name="CLoginForm" action= "CustomerServlet" method="post">
  ...
  <div class="container">
    ...
    <input type="text" placeholder="Enter Username" name="uname" onChange="validateForm()" required>
