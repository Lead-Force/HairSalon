<%-- 
    Document   : home
    Created on : Apr 12, 2021, 10:17:17 AM
    Author     : krism
--%>
          ...
          <li>
			<div class="dropdown">
				...
				<div class="dropdown-content">
					...
					<a href="../Employee/employeelogin.jsp">Employee</a>
...
<div class="container1" id="home">
  ...
  <h3 style="text-align:center; color:DarkBlue;">Want to checkout all the Services that we offer? Click <a href="services.jsp">here</a> or the Services tab in top menu!</h3>
