...
<%@page import="BO.Schedule"%>
<%@page import="java.util.ArrayList"%>
<%@page import="BO.HairDresser"%>
...
<html>
    ...
    <header>
    <div class="container">
      <a href="admin.jsp"><img src="Resources/image.png" alt="logo" class="logo"></a>
...
<br>
        ...
        <!-- Main Table *********************************************-->
        <h2>Schedule</h2>
        <form name="scheduleForm" action="http://localhost:8080/TheSalonProject/hdScheduleServlet" method="post">
            <table>
                <tr>
                    <th>Employee:</th>
                    <th>First Name</th>
            ...
            <p>Update records:
            <form name="ScheduleUpdateForm" action="http://localhost:8080/TheSalonProject/hdScheduleServlet" method="post">
            <table>
                <tr>
                    <!--<th>Employee:</th>-->
                    <th>Employee2:</th>
...
<button type="reset" value="Clear">Clear</button>  
        ...
        <p>
        <form name="HairDresserLookupForm" action="http://localhost:8080/TheSalonProject/hdScheduleServlet" method="post">
            <table>
                <tr>
                        <th>ID:</th>
                        <th>First name:</th>
