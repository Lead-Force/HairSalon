...
<br>
        ...
        <!-- Main Table *********************************************-->
        <h2 style="padding-left: 50px;">Schedule:</h2>
        <center>
                ...
                <% for(int row=0; row < sListSize; row++) { %>
                            <tbody>
                                <tr>
                                    ...
                                    <td class="column2"><%= casSchedule[row].getFirstName()%></td>
                                    <td class="column3"><%= casSchedule[row].getLastName()%></td>
                                    <!-- Text boxes-->
...
<!-- Availability****************************************-->
<h2 style="padding-left: 50px;">Availability</h2>
            <div class="limiter">
                <div class="container-table100">
                    <div class="wrap-table100">
                        <div class="table100">
        ...
        <a href="AdminLanding.jsp">To Landing</a>&emsp;&emsp;&emsp;&emsp;
